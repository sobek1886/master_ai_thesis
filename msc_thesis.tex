...
motion-preserving Unreal Engine avatar renders of a self-recorded Dutch
Sign Language (NGT) corpus, and diffusion-based per-frame appearance
edits (FLUX) of ASL Citizen videos. The outcome splits into two regimes.
...
\mainmatter
        ...
        \include{sections/4-setup}
        \include{sections/5-results}
        \include{sections/6-discussion}
        \include{sections/7-limitations}
