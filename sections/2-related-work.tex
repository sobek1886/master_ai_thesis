...
from your presentation, which the thesis never cited. Two corrections for
the slide: it is He, Shirakabe, Satoh and Kataoka, ECCV 2016 Workshops,
not ``Kataoka et al.\ 2024'', and the slide's $65.5\%$ is the ResNet-C3D
number on the detector-masked split, not a two-stream result. I quote the
two-stream pair here so both figures come from the same architecture.}
