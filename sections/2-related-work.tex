...
\todome{REWRITE (12.08): restructured into problem, action-recognition
remedies, why they do not transfer, sign language work, our position. The
opener said the problem ``was formalised early'', which RESOUND does not
do: it measures dataset bias empirically.}
...
people~\cite{liRESOUNDActionRecognition2018}.
...
is SDDA, which pairs diffusion-generated signer variety with a
consistency objective on a single studio-recorded
corpus~\cite{fuSignerDiversitydrivenData2024b}.
