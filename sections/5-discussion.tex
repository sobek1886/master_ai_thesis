...
to many signers, the appearance interventions returned a null: no
...
The SDDA authors flag the low visual realism of their synthesised signers
as a limitation. We draw no realism comparison against them: this thesis
measures no image-quality metric, and the one geometric readout we do have
runs the other way, since our edited clips stay near-perfectly separable
from real video (\S\ref{sec:results-aug-geometry}).
