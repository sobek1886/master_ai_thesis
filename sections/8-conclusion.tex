...
interventions: motion-preserving Unreal Engine avatar renders of a
self-recorded NGT corpus, where the counterfactual property holds by
construction, and diffusion-based per-frame appearance edits of ASL
...
low-diversity NGT setting --- four training signers, one studio
...
count, content, and viewpoint, the diffusion edits retain roughly
...
improving in-domain accuracy are dissociable outcomes here.
...
diversity is scarce --- our four-signer NGT corpus, and the
few-signer studio corpora of prior positive results --- synthetic
appearance counterfactuals earn their cost, and motion-preserving
renders earn the most; where hundreds of pretraining signers and diverse
...
diversity is what consumed the in-domain gain.
