...
directly.
\todome{CUT (12.08): the Byvshev sentence sat here. It read as though
Byvshev et al.\ had studied sign language, which they did not (3D
convolutional networks in general action recognition), and the claim it
made is already argued in \S\ref{sec:related-work-modality}, which cites
them properly.}
...
language domain.
\todome{CUT (12.08): the four-item remedy list that sat here (adversarial
invariant training, signer-diversity augmentation, pose-centric
modelling, challenge tracks) previewed the next paragraph's claim that
pose is the dominant response, and duplicated
\S\ref{sec:related-signer-independent}.}
