...
the frozen slope ($0.13$, $\rho=.03$). Training a head
...
single number and shows the split is systematic, not particular to the recipes above. All four backbone fine-tunes fall below the frozen
