...
\bottomrule
\end{tabular}
\caption{Real-signer-count ablation: cross-signer retrieval R@1 (0--1
scale), mean$\pm$sd over 3 seeds. $\Delta(S)$ is the paired gain of the
avatar arm over its matched real-only baseline, from unrounded means.
Arm codes are Table~\ref{tab:ngt_synthetic_views}'s, except E2$+$av., the
E2 arm carrying the same six avatar views ($K{=}9$). Per-seed exact
