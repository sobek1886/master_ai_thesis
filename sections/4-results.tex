...
mean$\pm$sd over 3 seeds. Re-renders are motion-locked Unreal
avatars, edits are generative appearance edits, both at the front camera
unless a view is named. E1 trains with the video-only InfoNCE (no
positive pairs at $K{=}1$); every other arm uses SupCon over its $K$
views. All arms share one
