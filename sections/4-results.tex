...
Table~\ref{tab:ngt_signer_count} shows both outcomes at once. The
real-only baseline barely moves with $S$: at a fixed 180-sentence budget,
adding real signers does not by itself improve cross-signer retrieval
(R@1 $0.21$--$0.24$ test$\to$train). The avatar gain does move, and in the
