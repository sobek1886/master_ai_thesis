...
glosses, so the intervention reaches a sixth of the vocabulary in every
row that uses it, not only in the row named after it. \emph{Synth.\ data only} replaces the real
