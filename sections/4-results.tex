...
\section{Cross-domain intervention: NGT744}
...
\bottomrule
\end{tabular}
\caption{Single-view NGT744 ladder: cross-signer retrieval (0--1 scale) with viewpoint
...
\caption{Single-view NGT744 ladder: cross-signer R@1 against the number of
...
Scratch on native (frozen) & RGB (MViTv2-S, native)   & 0.744 & \textbf{0.966} & \textbf{0.977} & 1 \\
...
low-signer NGT744 result (\S\ref{sec:results-crossdomain}). If instead the
