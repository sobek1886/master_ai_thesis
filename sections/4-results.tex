...
real-only arm barely moves with $S$: spreading the same 180 sentences
over one, two, three or four real signers leaves cross-signer retrieval at
R@1 $0.21$--$0.24$ (test$\to$train), so real signer variety at constant
data volume does not by itself help. The avatar gain does move, and in the
