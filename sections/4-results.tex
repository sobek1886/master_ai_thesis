...
\todome{NUMBERS BUG FIXED (12.08): the deltas here previously quoted the
E1$\to$E5 and E1$\to$E6 comparisons under a sentence about E3 and E4. Now
recomputed from unrounded means in ngt\_summary.json. Note the McNemar
test itself was only ever run for E5/E6, so significance is attributed to
those; if you want it stated for E3/E4 directly, that test still needs
running on the per-sentence ranks.}
