...
subsection.
\todome{ADDITION START (Claude 12.08): the subsection never named its own
table, and the row-naming key sat in the caption; both fixed here.}
...
\emph{$+$ synth.\ data} adds the Flux edits as extra training items,
...
\S\ref{sec:results-aug-geometry}: it does on the training pairs, but not
on held-out ones.
