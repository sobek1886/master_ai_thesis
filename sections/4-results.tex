...
subsuming both polysemy and minimal pairs. Logos authors show
...
other side. The pair-SupCon objective replaces the video--text loss
entirely (\S\ref{sec:method-objectives}), so nothing in it tells the
model that GUN1 and LIGHTER are different words; visual form is the only
axis left, and the space duly organises by it, at a cost of $0.567$
against $0.800$ V2T R@1 for the same edits used as ordinary training
data. Cross-entropy fine-tuning applies the opposite pressure, pulling
