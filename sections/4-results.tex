...
With viewpoint held fixed, both synthetic routes recover a large share of the cross-signer gap. Over the real-only baseline (E1, test$\to$train R@1 $0.234$), the
